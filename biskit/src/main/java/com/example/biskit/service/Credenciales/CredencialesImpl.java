...
public class CredencialesImpl implements CredencialesService {
    ...
    public void enviarCorreoResetPassword(String correo){
        ...
        if (clientsService.findByUsuario(correo) != null)
            contactable = clientsService.findByUsuario(correo);
        else if (vetService.findByUsuario(correo) != null)
            contactable = vetService.findByUsuario(correo);
        else if (adminService.findByUsuario(correo) != null)
            contactable = adminService.findByUsuario(correo);
