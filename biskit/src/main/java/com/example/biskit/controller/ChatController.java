...
public class ChatController {
  ...
  public ResponseEntity<ParticipanteChat> addParticipanteChat(
    @RequestBody ParticipanteChat participanteChat
  ) {
    return new ResponseEntity<>(
      chatService.addParticipanteChat(participanteChat),
      HttpStatus.CREATED
    );
  }
  ...
  public ResponseEntity<ParticipanteChat> updateParticipanteChat(
