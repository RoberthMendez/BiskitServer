...
public class DataLoader implements CommandLineRunner {
    ...
    public void cargarDatosCompletos() {
        ...
        // Necesitamos relacionar dueños/pets antes de crear chats basados en
        // tratamientos
        relacionar();
    ...
    public void cargarChats() {
        ...
        List<Vet> vets = vetsRepo.findAll().stream().filter(v -> v.getCredenciales() != null).toList();
        List<Client> clients = clientsRepo.findAll().stream().filter(c -> c.getCredenciales() != null).toList();

        Set<Long> usedVets = new HashSet<>();
        Set<Long> usedClients = new HashSet<>();
        ...
        for (Vet vet : vets) {
            ...
            for (Client client : clients) {
                if (created >= 3)
                    break;
                if (usedVets.contains(vet.getId()) || usedClients.contains(client.getId()))
                    continue;

                // obtener mascotas del cliente
                List<Pet> pets = petsRepo.findByOwnerIdIn(List.of(client.getId()));
                boolean tieneTratamientoCompartido = false;

                for (Pet pet : pets) {
                    List<Tratamiento> tratamientos = tratamientosService.getTratamientosByPetId(pet.getId());
                    if (tratamientos == null)
                        continue;
                    for (Tratamiento t : tratamientos) {
                        if (t.getVet() != null && t.getVet().getId() != null
                                && t.getVet().getId().equals(vet.getId())) {
                            tieneTratamientoCompartido = true;
                            break;
                        }
                    }
                    if (tieneTratamientoCompartido)
                        break;
                }
                ...
                Chat chat = chatService.addChat(Chat.builder()
                        .participantes(List.of(
                                ParticipanteChat.builder().credenciales(client.getCredenciales()).build(),
                                ParticipanteChat.builder().credenciales(vet.getCredenciales()).build()))
                        .build());

                if (chat.getParticipantes() != null && !chat.getParticipantes().isEmpty()) {
                    ParticipanteChat pClient = chat.getParticipantes().get(0);
                    ParticipanteChat pVet = chat.getParticipantes().size() > 1 ? chat.getParticipantes().get(1)
                            : pClient;

                    mensajeRepo.save(Mensaje.builder()
                            .remitente(pClient)
                            .contenido("Hola, soy " + client.getNombre() + ". Quisiera consultar por mi mascota.")
                            .timestamp(Timestamp.valueOf(LocalDateTime.now().plusMinutes(1)))
                            .build());

                    mensajeRepo.save(Mensaje.builder()
                            .remitente(pVet)
                            .contenido(
                                    "Hola " + client.getNombre() + ", con gusto te ayudo. Soy " + vet.getNombre() + ".")
                            .timestamp(Timestamp.valueOf(LocalDateTime.now().plusMinutes(2)))
                            .build());
                }

                usedVets.add(vet.getId());
                usedClients.add(client.getId());
                created++;
            }
        }
    }
    ...
    public void cargarClientes() {
        ...
        clientsRepo.save(
                Client.builder()
                        ...
                        .cedula("1015")
                        .correo("juan15@mail.com")
                        .celular("300000015")
                        .build());
        clientsRepo.save(
                Client.builder()
                        .nombre("Juliana Navarro")
                        .cedula("1016")
                        .correo("juliana16@mail.com")
                        .celular("300000016")
                        .build());
        clientsRepo.save(
                Client.builder()
        ...
        clientsRepo.save(
                Client.builder()
                        .nombre("Lucía Romero")
                        .cedula("1024")
                        .correo("lucia24@mail.com")
                        .celular("300000024")
                        .build());
        clientsRepo.save(
                Client.builder()
                        .nombre("Roberth Mendez")
                        .cedula("1025")
                        .correo("roberth25@mail.com")
                        .celular("300000025")
                        .build());
        clientsRepo.save(
                Client.builder()
                        .nombre("Mónica Vega")
                        .cedula("1026")
                        .correo("monica26@mail.com")
                        .celular("300000026")
                        .build());
        clientsRepo.save(
                Client.builder()
                        .nombre("Santiago Pardo")
                        .cedula("1027")
                        .correo("santiago27@mail.com")
                        .celular("300000027")
                        .build());
        clientsRepo.save(
                Client.builder()
                        .nombre("Luz Salazar")
                        .cedula("1028")
                        .correo("luz28@mail.com")
                        .celular("300000028")
                        .build());
        clientsRepo.save(
                Client.builder()
                        .nombre("Mauricio León")
                        .cedula("1029")
                        .correo("mauricio29@mail.com")
                        .celular("300000029")
                        .build());
        clientsRepo.save(
                Client.builder()
        ...
        clientsRepo.save(
                Client.builder()
                        .nombre("Kevin Rincón")
                        .cedula("1037")
                        .correo("kevin37@mail.com")
                        .celular("300000037")
                        .build());
        clientsRepo.save(
                Client.builder()
                        .nombre("Natalia Muñoz")
                        .cedula("1038")
                        .correo("natalia38@mail.com")
                        .celular("300000038")
                        .build());
        clientsRepo.save(
                Client.builder()
        ...
        clientsRepo.save(
                Client.builder()
                        .nombre("David Zapata")
                        .cedula("1041")
                        .correo("david41@mail.com")
                        .celular("300000041")
                        .build());
        clientsRepo.save(
                Client.builder()
                        .nombre("Lorena Hidalgo")
                        .cedula("1042")
                        .correo("lorena42@mail.com")
                        .celular("300000042")
                        .build());
        clientsRepo.save(
                Client.builder()
                        .nombre("Tomás Medina")
                        .cedula("1043")
                        .correo("tomas43@mail.com")
                        .celular("300000043")
                        .build());
        clientsRepo.save(
                Client.builder()
                        .nombre("Angela Prieto")
                        .cedula("1044")
                        .correo("angela44@mail.com")
                        .celular("300000044")
                        .build());
        clientsRepo.save(
                Client.builder()
        ...
        clientsRepo.save(
                Client.builder()
                        .nombre("Mariana Quintero")
                        .cedula("1046")
                        .correo("mariana46@mail.com")
                        .celular("300000046")
                        .build());
        clientsRepo.save(
                Client.builder()
                        .nombre("Raúl Rivas")
                        .cedula("1047")
                        .correo("raul47@mail.com")
                        .celular("300000047")
                        .build());
        clientsRepo.save(
                Client.builder()
                        .nombre("Tatiana Lozano")
                        .cedula("1048")
                        .correo("tatiana48@mail.com")
                        .celular("300000048")
                        .build());
        clientsRepo.save(
                Client.builder()
    ...
    public void cargarMascotas() {
        ...
        petsRepo.save(
                Pet.builder()
                        ...
                        .fechaNacimiento(calcularFechaNacimiento(4))
                        .peso(27f)
        ...
        petsRepo.save(
                Pet.builder()
                        ...
                        .fechaNacimiento(calcularFechaNacimiento(3))
                        .peso(12f)
        ...
        petsRepo.save(
                Pet.builder()
                        ...
                        .fechaNacimiento(calcularFechaNacimiento(5))
                        .peso(30f)
        ...
        petsRepo.save(
                Pet.builder()
                        ...
                        .fechaNacimiento(calcularFechaNacimiento(2))
                        .peso(8f)
        ...
        petsRepo.save(
                Pet.builder()
                        ...
                        .fechaNacimiento(calcularFechaNacimiento(6))
                        .peso(6f)
        ...
        petsRepo.save(
                Pet.builder()
                        ...
                        .fechaNacimiento(calcularFechaNacimiento(1))
                        .peso(3.8f)
    ...
    public void cargarVeterinarios() {
        ...
        vetsRepo.save(
                Vet.builder()
                        ...
                        .cedula("102")
                        .urlFoto(
                                "https://clinicaveterinariasangabriel.pe/wp-content/uploads/2016/06/DSC_07971-1024x925-1.jpg")
                        .build());
        vetsRepo.save(
                Vet.builder()
                        ...
                        .cedula("103")
                        .urlFoto(
                                "https://fotografias-compromiso.atresmedia.com/clipping/cmsimages02/2017/02/10/3BA9F907-971E-44D3-9141-932BD321F2BB/69.jpg")
                        .build());
        vetsRepo.save(
                Vet.builder()
                        ...
                        .cedula("104")
                        .urlFoto(
                                "https://media.revistagq.com/photos/690360f8591bc73019a99e6f/master/w_1600%2Cc_limit/MEN_PRECO_SS26_CAMPAIGN_VISUAL_PRESS_1920x1080_12.jpg")
                        .build());
        vetsRepo.save(
                Vet.builder()
                        .nombre("Carla García")
                        ...
                        .cedula("105")
                        .urlFoto(
                                "https://img.freepik.com/foto-gratis/veterinario-que-controla-salud-cachorro_23-2148728396.jpg?semt=ais_rp_50_assets&w=740&q=80")
                        .build());
        vetsRepo.save(
                Vet.builder()
                        .nombre("Isabella Garzón")
                        .estado(true)
                        .correo("isabella.garzon@biskit.com")
                        .cedula("106")
                        .urlFoto(
                                "https://www.polisura.edu.co/wp-content/uploads/2024/02/Auxiliar-Veterinaria-2.jpg")
                        .build());
        vetsRepo.save(
                Vet.builder()
                        ...
                        .cedula("107")
                        .urlFoto(
                                "https://veterinariacavero.com/wp-content/uploads/2024/08/Dr-Omar-cavero-Medico-Veterinario-especializado-en-Neurologia-y-Traumatologia.jpg")
                        .build());
        vetsRepo.save(
                Vet.builder()
        ...
        vetsRepo.save(
                Vet.builder()
                        ...
                        .cedula("109")
                        .urlFoto(
                                "https://veterinariaevi.com/cdn/shop/files/WhatsApp_Image_2025-08-20_at_5.10.53_PM.jpg?v=1755728649&width=3840")
                        .build());
        vetsRepo.save(
                Vet.builder()
                        .nombre("Nadia Jiménez")
                        .estado(true)
                        .correo("nadia.jimenez@biskit.com")
                        .cedula("110")
                        .urlFoto(
                                "https://eq2imhfmrcc.exactdn.com/wp-content/uploads/2012/06/perro-veterinaria.jpg?strip=all")
                        .build());
        vetsRepo.save(
                Vet.builder()
        ...
        vetsRepo.save(
                Vet.builder()
                        ...
                        .cedula("112")
                        .urlFoto(
                                "https://img.asmedia.epimg.net/resizer/v2/WXH3ZXRSKNPFPFMDOTZRZO2WFM.jpg?auth=9256d50aad4bf08c2f7732f212ee45615b2c4f6387aa0aea6cd805fb1927e5cb&width=1200&height=1200&smart=true")
                        .build());
    }

    public void cargarAdministradores() {
        adminRepo.save(
                Admin.builder().nombre("Roberth").correo("roberth@biskit.com").cedula("10").build());
        adminRepo.save(Admin.builder().nombre("Guden").correo("guden@biskit.com").cedula("20").build());
        adminRepo.save(Admin.builder().nombre("Luz").correo("luz@biskit.com").cedula("30").build());
        adminRepo.save(
                Admin.builder().nombre("Santiago").correo("santiago@biskit.com").cedula("40").build());
        adminRepo.save(
                Admin.builder().nombre("Angarita").correo("angarita@biskit.com").cedula("50").build());
    }
    ...
    public void cargarTratamientos() {
        ...
        for (int i = 0; i < 200; i++) {
            ...
            while (drogasTratamiento.size() < cantidadDrogasTratamiento) {
                ...
                if (droga != null && droga.getUnidadesDisponibles() > 0 && !drogasTratamiento.contains(droga)) {
    ...
    private void cargarHorariosDia() {
            ...
            for (Turno turno : turnosDia) {
                ...
                for (Vet vet : vetsDisponibles) {
                    ...
                    boolean mejorOpcion = vetSeleccionado == null ||
                            diasAsignadosPorVet.get(vetId) < diasAsignadosPorVet.get(vetSeleccionado.getId());
                ...
                horariosDiaRepo.save(
                        HorarioDia.builder().diaSemana(diaSemana).turno(turno).vet(vetSeleccionado).build());

                diasAsignadosPorVet.put(
        ...
        for (Vet vet : veterinarios) {
            ...
            while (diasAsignadosPorVet.get(vetId) < 5) {
                ...
                horariosDiaRepo.save(
                        HorarioDia.builder().diaSemana(diaSemana).turno(turno).vet(vet).build());
    ...
    public void cargarTiposCita() {
        tiposCitaRepo.save(TipoCita.builder().nombre("Consulta general").duracionMinutos(45).build());

        tiposCitaRepo.save(
                TipoCita.builder().nombre("Consulta de Control").duracionMinutos(30).build());

        tiposCitaRepo.save(TipoCita.builder().nombre("Vacunación").duracionMinutos(30).build());

        tiposCitaRepo.save(TipoCita.builder().nombre("Desparasitación").duracionMinutos(30).build());

        tiposCitaRepo.save(
                TipoCita.builder().nombre("Consulta especializada").duracionMinutos(60).build());

        tiposCitaRepo.save(
                TipoCita.builder().nombre("Certificado para viaje").duracionMinutos(60).build());

        tiposCitaRepo.save(
                TipoCita.builder().nombre("Exámenes diagnósticos").duracionMinutos(45).build());

        tiposCitaRepo.save(
                TipoCita.builder().nombre("Consulta domiciliaria").duracionMinutos(60).build());
    }

    public void cargarCitas() {
        Random random = new Random(42);
        Map<Long, Integer> citasPorVet = new HashMap<>();
        Map<String, Integer> citasPorDia = new HashMap<>();

        // Inicializar contador de días
        citasPorDia.put("Lunes", 0);
        citasPorDia.put("Martes", 0);
        citasPorDia.put("Miercoles", 0);
        citasPorDia.put("Jueves", 0);
        citasPorDia.put("Viernes", 0);
        citasPorDia.put("Sabado", 0);
        citasPorDia.put("Domingo", 0);
    ...
    private void cargarCitasParaSemana(
            ...
            int cantidad,
            Random random,
            Map<Long, Integer> citasPorVet,
            Map<String, Integer> citasPorDia) {
        List<TipoCita> tiposCita = tiposCitaRepo.findAll();
        List<Pet> mascotas = petsRepo.findAll();

        if (tiposCita.isEmpty() || mascotas.isEmpty()) {
            return;
        }

        List<HorarioDia> horariosDisponibles = horariosDiaRepo
                .findAll()
                .stream()
                .filter(horario -> fechaParaDiaSemana(inicioSemana, horario.getDiaSemana()) != null)
                .toList();
        ...
        Map<Long, List<HorarioDia>> horariosPorVet = horariosDisponibles
                .stream()
                .collect(java.util.stream.Collectors.groupingBy(horario -> horario.getVet().getId()));

        int citasCreadas = 0;
        int indiceTipo = 0;
        int indiceMascota = 0;

        while (citasCreadas < cantidad) {
            TipoCita tipo = tiposCita.get(indiceTipo % tiposCita.size());
            Pet pet = mascotas.get(indiceMascota % mascotas.size());

            boolean creada = intentarCrearCitaBalanceada(
                    inicioSemana,
                    tipo,
                    pet,
                    horariosPorVet,
            ...
            if (!creada) {
                throw new IllegalStateException(
                        "No se pudo encontrar un horario disponible para cargar la cita " +
                                (citasCreadas + 1) +
                                " de " +
                                cantidad +
                                " en la semana " +
    ...
    private boolean intentarCrearCitaBalanceada(
            LocalDate inicioSemana,
            TipoCita tipo,
            Pet pet,
            Map<Long, List<HorarioDia>> horariosPorVet,
            Map<Long, Integer> citasPorVet,
            Map<String, Integer> citasPorDia) {
        List<Long> vetsOrdenados = horariosPorVet
                .keySet()
                .stream()
                .sorted(
                        java.util.Comparator.comparingInt((Long vetId) -> citasPorVet.getOrDefault(vetId, 0))
                                .thenComparingLong(Long::longValue))
                .toList();

        for (Long vetId : vetsOrdenados) {
            List<HorarioDia> horariosVet = horariosPorVet.get(vetId);
            if (horariosVet == null || horariosVet.isEmpty()) {
                continue;
            }

            for (HorarioDia horario : ordenarHorariosDeSemana(inicioSemana, horariosVet, citasPorDia)) {
                LocalDate fecha = fechaParaDiaSemana(inicioSemana, horario.getDiaSemana());
                if (fecha == null) {
                    continue;
                }

                if (intentarCrearCitaEnHorario(fecha, horario, tipo, pet)) {
                    citasPorVet.put(vetId, citasPorVet.getOrDefault(vetId, 0) + 1);
                    citasPorDia.put(
                            horario.getDiaSemana(),
                            citasPorDia.getOrDefault(horario.getDiaSemana(), 0) + 1);
                    return true;
                }
            }
        }
    ...
    private boolean intentarCrearCitaEnHorario(
            LocalDate fecha,
            HorarioDia horario,
            TipoCita tipo,
            Pet pet) {
        LocalTime horaInicio = horario.getTurno().getHoraInicio();
        LocalTime horaFin = horario.getTurno().getHoraFin();
        int duracionMinutos = tipo.getDuracionMinutos();

        LocalTime horaActual = horaInicio;
        LocalTime ultimaHoraPosible = horaFin.minusMinutes(duracionMinutos);

        while (!horaActual.isAfter(ultimaHoraPosible)) {
            try {
                Cita cita = Cita.builder()
                        .fechaHora(fecha.atTime(horaActual))
                        .tipoCita(tipo)
                        .vet(horario.getVet())
                        .pet(pet)
                        .build();
    ...
    private List<HorarioDia> ordenarHorariosDeSemana(
            LocalDate inicioSemana,
        ...
        return horarios
                ...
                .sorted(
                        java.util.Comparator
                                .comparingInt(
                                        (HorarioDia horario) -> citasPorDia.getOrDefault(horario.getDiaSemana(), 0))
                                .thenComparing(horario -> fechaParaDiaSemana(inicioSemana, horario.getDiaSemana()))
                                .thenComparing(horario -> horario.getTurno().getHoraInicio()))
                .toList();
    }

    private LocalDate fechaParaDiaSemana(LocalDate inicioSemana, String diaSemana) {
        if (diaSemana == null) {
            return null;
        }
        ...
        return switch (diaNormalizado) {
            case "lunes" -> inicioSemana;
            case "martes" -> inicioSemana.plusDays(1);
            case "miercoles" -> inicioSemana.plusDays(2);
            case "jueves" -> inicioSemana.plusDays(3);
            case "viernes" -> inicioSemana.plusDays(4);
            case "sabado" -> inicioSemana.plusDays(5);
            case "domingo" -> inicioSemana.plusDays(6);
            default -> null;
        };
    }
