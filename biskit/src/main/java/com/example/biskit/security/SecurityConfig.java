    ...
    http
      ...
      .authorizeHttpRequests(requests ->
        requests
          ...
          .permitAll()
          .requestMatchers("/enfermedades/**")
          .hasAnyAuthority("ADMIN", "VET")
          .requestMatchers("/razas/**")
          .hasAnyAuthority("ADMIN", "VET")
          .requestMatchers("/especies/**")
          .hasAnyAuthority("ADMIN", "VET")
          .requestMatchers("/especialidades/**")
          .hasAuthority("ADMIN")
          .requestMatchers("/vets/details")
          .hasAnyAuthority("VET")
          .requestMatchers("/vets/{id}/tratamientos/**")
          .hasAnyAuthority("ADMIN", "VET")
          .requestMatchers("/vets/{id}/horario-semanal")
          .hasAnyAuthority("ADMIN", "VET")
          .requestMatchers("/vets/{id}/citas-semanales")
          .hasAnyAuthority("ADMIN", "VET")
          .requestMatchers("/vets/{id}/citas-semanales-sin-mascota")
          .hasAnyAuthority("ADMIN", "VET")
          ...
          .hasAnyAuthority("ADMIN", "VET")
          .requestMatchers("/clients/details")
          .hasAnyAuthority("CLIENT")
          .requestMatchers("/clients/{id}")
          .hasAnyAuthority("ADMIN", "VET", "CLIENT")
          .requestMatchers("/clients/{id}/pets")
          .hasAnyAuthority("ADMIN", "VET", "CLIENT")
          .requestMatchers("/clients/{id}/**")
          .hasAnyAuthority("ADMIN", "VET")
          .requestMatchers("/clients/**")
          .hasAnyAuthority("ADMIN", "VET")
          .requestMatchers("/drogas/**")
          .hasAnyAuthority("ADMIN", "VET")
          .requestMatchers("/filtros/**")
          .hasAnyAuthority("ADMIN", "VET")
          .requestMatchers("/pets/{id}")
          .hasAnyAuthority("ADMIN", "VET", "CLIENT")
          .requestMatchers("/pets/{id}/owner")
          .hasAnyAuthority("ADMIN", "VET", "CLIENT")
          .requestMatchers("/pets/{id}/tratamientos")
          .hasAnyAuthority("ADMIN", "VET", "CLIENT")
