    ...
    http
      ...
      .authorizeHttpRequests(requests ->
        requests
          ...
          .requestMatchers("/vets/details").hasAnyAuthority("VET")
          ...
          .requestMatchers("/clients/details").hasAnyAuthority("CLIENT")
          .requestMatchers("/clients/{id}").hasAnyAuthority("ADMIN", "VET", "CLIENT")
          .requestMatchers("/clients/{id}/pets").hasAnyAuthority("ADMIN", "VET", "CLIENT")
          .requestMatchers("/clients/{id}/**").hasAnyAuthority("ADMIN", "VET")
          ...
          .requestMatchers("/pets/{id}/owner").hasAnyAuthority("ADMIN", "VET", "CLIENT")
          .requestMatchers("/pets/{id}/tratamientos").hasAnyAuthority("ADMIN", "VET", "CLIENT")
