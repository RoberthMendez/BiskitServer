...
public class TratamientoServiceTestNaive {
  ...
  public void setUp() {
    ...
    Pet pet1 = Pet.builder()
      .nombre("Firulais")
      .fechaNacimiento(new java.sql.Date(cal.getTimeInMillis()))
      .estado(true)
      .build();
  ...
  public void tratamientoService_addTratamientoDto_void() {
    ...
    Assertions.assertThat(despues.getUnidadesDisponibles()).isEqualTo(disponiblesAntes - 1);

    // Debe aumentar vendidas en 1
    Assertions.assertThat(despues.getUnidadesVendidas()).isEqualTo(vendidasAntes + 1);
  }
  ...
  public void tratamientoService_deleteTratamiento_void() {
    ...
    // Assert
    Assertions.assertThatThrownBy(() -> tratamientoService.getTratamientoById(idToDelete))
  ...
  public void tratamientoService_getDrogaTratamientosMesCount() {
    ...
    Assertions.assertThat(dto.getCount()).isEqualTo(1L);
  }
